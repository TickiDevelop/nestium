...
import net.caffeinemc.mods.nestium.client.compatibility.workarounds.intel.IntelWorkarounds;
import net.caffeinemc.mods.nestium.client.compatibility.workarounds.nvidia.NvidiaDriverVersion;
...
import net.caffeinemc.mods.nestium.client.platform.PlatformHelper;
        ...
        if (vendor == GraphicsAdapterVendor.INTEL && BugChecks.ISSUE_899) {
            ...
            if (installedVersion != null) {
                ...
                PlatformHelper.showCriticalErrorAndClose(window,
                        "Nestium Renderer - Unsupported Driver",
                        """
                        ...
                        "https://link.caffeinemc.net/help/nestium/graphics-driver/windows/intel/gh-899");
            }
        }
            ...
            if (installedVersion != null) {
                ...
                PlatformHelper.showCriticalErrorAndClose(window,
                        ...
                        """
                                ...
                                Please click the 'Help' button to read more about how to fix this problem."""
                                .replace("###CURRENT_DRIVER###", installedVersionString),
                        "https://link.caffeinemc.net/help/nestium/graphics-driver/windows/nvidia/gh-1486");
