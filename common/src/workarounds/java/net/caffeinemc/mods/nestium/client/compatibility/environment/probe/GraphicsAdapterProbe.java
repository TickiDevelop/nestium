package net.caffeinemc.mods.nestium.client.compatibility.environment.probe;
...
public class GraphicsAdapterProbe {
    private static final Logger LOGGER = LoggerFactory.getLogger("Nestium-GraphicsAdapterProbe");
