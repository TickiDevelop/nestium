...
public class PreLaunchChecks {
    ...
    private static void checkLwjglRuntimeVersion() {
        ...
        PlatformHelper.showCriticalErrorAndClose(null, "Nestium Renderer - Unsupported LWJGL", message,
                "https://link.caffeinemc.net/help/nestium/runtime-issue/lwjgl3/gh-2561");
    }
