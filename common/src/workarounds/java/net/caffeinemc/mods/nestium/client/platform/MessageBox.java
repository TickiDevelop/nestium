package net.caffeinemc.mods.nestium.client.platform;

import net.caffeinemc.mods.nestium.client.compatibility.environment.OsUtils;
import net.caffeinemc.mods.nestium.client.platform.windows.api.Shell32;
import net.caffeinemc.mods.nestium.client.platform.windows.api.User32;
import net.caffeinemc.mods.nestium.client.platform.windows.api.msgbox.MsgBoxCallback;
import net.caffeinemc.mods.nestium.client.platform.windows.api.msgbox.MsgBoxParamSw;
