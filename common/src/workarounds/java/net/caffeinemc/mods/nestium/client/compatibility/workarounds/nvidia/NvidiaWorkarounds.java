package net.caffeinemc.mods.nestium.client.compatibility.workarounds.nvidia;

import net.caffeinemc.mods.nestium.client.compatibility.environment.GlContextInfo;
import net.caffeinemc.mods.nestium.client.compatibility.environment.OsUtils;
import net.caffeinemc.mods.nestium.client.compatibility.environment.OsUtils.OperatingSystem;
import net.caffeinemc.mods.nestium.client.compatibility.environment.probe.GraphicsAdapterProbe;
import net.caffeinemc.mods.nestium.client.compatibility.environment.probe.GraphicsAdapterVendor;
import net.caffeinemc.mods.nestium.client.compatibility.workarounds.Workarounds;
import net.caffeinemc.mods.nestium.client.platform.unix.Libc;
import net.caffeinemc.mods.nestium.client.platform.windows.WindowsCommandLine;
import net.caffeinemc.mods.nestium.client.platform.windows.WindowsFileVersion;
import net.caffeinemc.mods.nestium.client.platform.windows.api.d3dkmt.D3DKMT;
...
public class NvidiaWorkarounds {
    private static final Logger LOGGER = LoggerFactory.getLogger("Nestium-NvidiaWorkarounds");
    ...
    // https://github.com/CaffeineMC/nestium/issues/1486
    ...
    private static void applyEnvironmentChanges$Windows() {
        ...
        // be enabled.
        WindowsCommandLine.setCommandLine("net.caffeinemc.nestium / net.minecraft.client.main.Main /");
    }
    ...
    private static void logWarning() {
        ...
        LOGGER.error("READ ME!   https://github.com/CaffeineMC/nestium/issues");
        LOGGER.error("READ ME!");
