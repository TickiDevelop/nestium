package net.caffeinemc.mods.nestium.client.platform.windows;

import net.caffeinemc.mods.nestium.client.platform.windows.api.version.VersionFixedFileInfoStruct;
