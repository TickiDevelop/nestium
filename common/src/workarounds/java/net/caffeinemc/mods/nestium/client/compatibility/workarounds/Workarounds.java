package net.caffeinemc.mods.nestium.client.compatibility.workarounds;
...
public class Workarounds {
    private static final Logger LOGGER = LoggerFactory.getLogger("Nestium-Workarounds");
    ...
    public static void init() {
        ...
        if (!workarounds.isEmpty()) {
            LOGGER.warn("Nestium has applied one or more workarounds to prevent crashes or other issues on your system: [{}]",
                    workarounds.stream()
                            .map(Enum::name)
    ...
    public enum Reference {
         ...
         * <a href="https://github.com/CaffeineMC/nestium/issues/1816">GitHub Issue</a>
         */
        NVIDIA_THREADED_OPTIMIZATIONS_BROKEN,

        /**
         * Requesting a No Error Context causes a crash at startup when using a Wayland session.
         * <a href="https://github.com/CaffeineMC/nestium/issues/1624">GitHub Issue</a>
         */
         ...
         * <a href="https://github.com/CaffeineMC/nestium/issues/2727">GitHub Issue</a>
         */
         ...
         * the base model.
         * <a href="https://github.com/CaffeineMC/nestium/issues/2830">GitHub Issue</a>
         */
