...
public enum ResourceHacks {
    ...
    public static void addChestParticleTexture(String chestName, String chestTexture, ResourceManager manager, EBEPack pack) throws IOException {
        cropAndPutTexture(
                ResourceLocation.withDefaultNamespace("textures/" + chestTexture + ".png"),
                ResourceLocation.withDefaultNamespace("textures/block/" + chestName + "_particle.png"),
                manager, pack,
    ...
    public static void addBedParticleTexture(String bedColor, String bedTexture, ResourceManager manager, EBEPack pack) throws IOException {
        cropAndPutTexture(
                ResourceLocation.withDefaultNamespace("textures/" + bedTexture + ".png"),
                ResourceLocation.withDefaultNamespace("textures/block/" + bedColor + "_bed_particle.png"),
                manager, pack,
    ...
    public static void addSignParticleTexture(String signType, String signTexture, ResourceManager manager, EBEPack pack) throws IOException {
        cropAndPutTexture(
                ResourceLocation.withDefaultNamespace("textures/" + signTexture + ".png"),
                ResourceLocation.withDefaultNamespace("textures/block/" + signType + "_sign_particle.png"),
                manager, pack,
