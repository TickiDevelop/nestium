...
public class RenderSectionManagerMixin {
    @ModifyVariable(method = "submitSectionTasks(Lnet/caffeinemc/mods/nestium/client/render/chunk/compile/executor/ChunkJobCollector;Lnet/caffeinemc/mods/nestium/client/render/chunk/ChunkUpdateType;Z)V",
            at = @At(value = "INVOKE", shift = At.Shift.BEFORE, ordinal = 0, target = "Lnet/caffeinemc/mods/nestium/client/render/chunk/RenderSection;isDisposed()Z"),
            index = 5, require = 0
    )
    ...
    @ModifyVariable(method = "processChunkBuildResults",
            at = @At(value = "INVOKE_ASSIGN", shift = At.Shift.BEFORE, ordinal = 0, target = "Lnet/caffeinemc/mods/nestium/client/render/chunk/RenderSection;getTaskCancellationToken()Lnet/caffeinemc/mods/nestium/client/util/task/CancellationToken;"),
            index = 5, require = 0
    )
