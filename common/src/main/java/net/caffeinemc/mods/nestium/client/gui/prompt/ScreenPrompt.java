...
import net.caffeinemc.mods.nestium.client.gui.widgets.AbstractWidget;
...
public class ScreenPrompt implements GuiEventListener, Renderable {
    ...
    public void init() {
        ...
        this.closeButton = new FlatButtonWidget(new Dim2i((boxX + width) - 84, (boxY + height) - 24, 80, 20), Component.translatable("nestium.prompt.close"), this::close);
