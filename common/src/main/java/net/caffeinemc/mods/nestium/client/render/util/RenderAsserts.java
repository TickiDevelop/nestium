package net.caffeinemc.mods.nestium.client.render.util;
...
public class RenderAsserts {
    ...
    public static boolean validateCurrentThread() {
        if (!RenderSystem.isOnRenderThread()) {
            throw new IllegalStateException("Accessing OpenGL functions from outside the main render thread is not supported when using Nestium");
        }
