package net.caffeinemc.mods.nestium.client.gl.shader;

import com.mojang.blaze3d.platform.GlStateManager;
import net.caffeinemc.mods.nestium.client.gl.GlObject;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniform;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniformBlock;
import net.caffeinemc.mods.nestium.client.render.chunk.shader.ShaderBindingContext;
