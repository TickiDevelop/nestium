package net.caffeinemc.mods.nestium.client.gl.arena;
...
import net.caffeinemc.mods.nestium.client.gl.buffer.GlBufferUsage;
import net.caffeinemc.mods.nestium.client.gl.buffer.GlMutableBuffer;
