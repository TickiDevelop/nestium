...
import net.caffeinemc.mods.nestium.client.render.chunk.shader.*;
...
import net.caffeinemc.mods.nestium.client.gl.shader.*;
...
public abstract class ShaderChunkRenderer implements ChunkRenderer {
    ...
    private GlProgram<ChunkShaderInterface> createShader(String path, ChunkShaderOptions options) {
        ...
        GlShader vertShader = ShaderLoader.loadShader(ShaderType.VERTEX,
                ResourceLocation.fromNamespaceAndPath("nestium", path + ".vsh"), constants);

        GlShader fragShader = ShaderLoader.loadShader(ShaderType.FRAGMENT,
                ResourceLocation.fromNamespaceAndPath("nestium", path + ".fsh"), constants);

        try {
            return GlProgram.builder(ResourceLocation.fromNamespaceAndPath("nestium", "chunk_shader"))
