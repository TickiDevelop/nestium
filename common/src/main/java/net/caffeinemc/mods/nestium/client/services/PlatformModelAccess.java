...
public interface PlatformModelAccess {
     ...
     */
    Iterable<RenderType> getModelRenderTypes(BlockAndTintGetter level, BakedModel model, BlockState state, BlockPos pos, RandomSource random, NestiumModelData modelData);
     ...
     */
    List<BakedQuad> getQuads(BlockAndTintGetter level, BlockPos pos, BakedModel model, BlockState state, Direction face, RandomSource random, RenderType renderType, NestiumModelData modelData);
     ...
     */
    NestiumModelDataContainer getModelDataContainer(Level level, SectionPos sectionPos);
     ...
     */
    NestiumModelData getModelData(LevelSlice slice, BakedModel model, BlockState state, BlockPos pos, NestiumModelData originalData);

    /**
     * Should not use. <b>Use {@code NestiumModelData.EMPTY} instead.</b>
     * @return The empty model data for this platform.
     */
    @ApiStatus.Internal
    NestiumModelData getEmptyModelData();
}
