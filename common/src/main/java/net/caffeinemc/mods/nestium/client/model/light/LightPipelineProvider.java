package net.caffeinemc.mods.nestium.client.model.light;

import net.caffeinemc.mods.nestium.client.model.light.data.LightDataAccess;
import net.caffeinemc.mods.nestium.client.model.light.flat.FlatLightPipeline;
import net.caffeinemc.mods.nestium.client.model.light.smooth.SmoothLightPipeline;
