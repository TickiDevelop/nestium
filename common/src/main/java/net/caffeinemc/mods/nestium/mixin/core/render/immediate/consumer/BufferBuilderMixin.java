package net.caffeinemc.mods.nestium.mixin.core.render.immediate.consumer;

import com.mojang.blaze3d.vertex.BufferBuilder;
import com.mojang.blaze3d.vertex.ByteBufferBuilder;
import com.mojang.blaze3d.vertex.VertexFormat;
import net.caffeinemc.mods.nestium.api.memory.MemoryIntrinsics;
...
public abstract class BufferBuilderMixin implements VertexBufferWriter, BufferBuilderExtension {
    ...
    @Override
    public void nestium$duplicateVertex() {
        if (this.vertices == 0) {
            return;
        }
