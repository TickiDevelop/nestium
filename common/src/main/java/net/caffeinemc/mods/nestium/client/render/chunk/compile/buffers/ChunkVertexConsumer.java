package net.caffeinemc.mods.nestium.client.render.chunk.compile.buffers;
...
public class ChunkVertexConsumer implements VertexConsumer {
    ...
    // Writing color ignores alpha since alpha is used as a color multiplier by Nestium.
    @Override
