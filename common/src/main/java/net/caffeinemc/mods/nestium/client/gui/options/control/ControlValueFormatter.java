...
public interface ControlValueFormatter {
    ...
    static ControlValueFormatter biomeBlend() {
        return (v) -> (v == 0) ? Component.translatable("gui.none") : Component.translatable("nestium.options.biome_blend.value", v);
    }
    ...
    static ControlValueFormatter quantityOrDisabled(String nameKey, String disableTextKey) {
        return (v) -> v == 0 ? Component.translatable(disableTextKey) : Component.translatable(nameKey, v);
    }
