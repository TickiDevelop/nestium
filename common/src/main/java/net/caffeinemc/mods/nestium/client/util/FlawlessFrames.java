package net.caffeinemc.mods.nestium.client.util;
...
/**
 * Implements the "Flawless Frames" FREX feature using which third-party mods can instruct Nestium to sacrifice
 ...
 * <p>
 * In Nestium's case, this means waiting for all chunks to be fully updated and ready for rendering before each frame.
 * <p>
