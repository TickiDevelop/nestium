package net.caffeinemc.mods.nestium.client.data.config;

import net.caffeinemc.mods.nestium.client.services.PlatformMixinOverrides;
import net.caffeinemc.mods.nestium.client.services.Services;
import net.caffeinemc.mods.nestium.mixin.MixinOption;
...
/**
 * <a href="https://github.com/CaffeineMC/nestium/wiki/Configuration-File">Documentation of these options...</a>
 */
@SuppressWarnings("CanBeFinal")
public class MixinConfig {
    protected static final Logger LOGGER = LogManager.getLogger("NestiumConfig");
    ...
    private static void writeDefaultConfig(File file) throws IOException {
        ...
        try (Writer writer = new FileWriter(file)) {
            writer.write("# This is the configuration file for Nestium.\n");
            writer.write("#\n");
            writer.write("# You can find information on editing this file and all the available options here:\n");
            writer.write("# https://github.com/CaffeineMC/nestium/wiki/Configuration-File\n");
            writer.write("#\n");
