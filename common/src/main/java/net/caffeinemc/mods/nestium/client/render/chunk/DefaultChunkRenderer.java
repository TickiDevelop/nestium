...
import net.caffeinemc.mods.nestium.client.gl.attribute.GlVertexAttributeBinding;
import net.caffeinemc.mods.nestium.client.gl.device.CommandList;
import net.caffeinemc.mods.nestium.client.gl.device.DrawCommandList;
import net.caffeinemc.mods.nestium.client.gl.device.MultiDrawBatch;
...
import net.caffeinemc.mods.nestium.client.gl.tessellation.GlPrimitiveType;
import net.caffeinemc.mods.nestium.client.gl.tessellation.GlTessellation;
import net.caffeinemc.mods.nestium.client.gl.tessellation.TessellationBinding;
import net.caffeinemc.mods.nestium.client.model.quad.properties.ModelQuadFacing;
import net.caffeinemc.mods.nestium.client.render.chunk.data.SectionRenderDataStorage;
import net.caffeinemc.mods.nestium.client.render.chunk.data.SectionRenderDataUnsafe;
import net.caffeinemc.mods.nestium.client.render.chunk.lists.ChunkRenderList;
import net.caffeinemc.mods.nestium.client.render.chunk.lists.ChunkRenderListIterable;
import net.caffeinemc.mods.nestium.client.render.chunk.region.RenderRegion;
import net.caffeinemc.mods.nestium.client.render.chunk.shader.ChunkShaderBindingPoints;
import net.caffeinemc.mods.nestium.client.render.chunk.shader.ChunkShaderInterface;
...
import net.caffeinemc.mods.nestium.client.render.chunk.vertex.format.ChunkVertexType;
import net.caffeinemc.mods.nestium.client.render.viewport.CameraTransform;
import net.caffeinemc.mods.nestium.client.util.BitwiseMath;
import net.caffeinemc.mods.nestium.client.util.UInt32;
...
public class DefaultChunkRenderer extends ShaderChunkRenderer {
    ...
    public void render(ChunkRenderMatrices matrices,
        ...
        final boolean useBlockFaceCulling = NestiumClientMod.options().performance.useBlockFaceCulling;
    ...
    private static boolean isTranslucentRenderPass(TerrainRenderPass renderPass) {
        return renderPass.isTranslucent() && NestiumClientMod.options().debug.getSortBehavior() != SortBehavior.OFF;
    }
