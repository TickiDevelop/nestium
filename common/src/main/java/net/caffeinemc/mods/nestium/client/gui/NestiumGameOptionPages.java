...
import net.caffeinemc.mods.nestium.client.compatibility.environment.OsUtils;
import net.caffeinemc.mods.nestium.client.compatibility.workarounds.Workarounds;
import net.caffeinemc.mods.nestium.client.gl.arena.staging.MappedStagingBuffer;
import net.caffeinemc.mods.nestium.client.gl.device.RenderDevice;
import net.caffeinemc.mods.nestium.client.gui.options.*;
import net.caffeinemc.mods.nestium.client.gui.options.binding.compat.VanillaBooleanOptionBinding;
import net.caffeinemc.mods.nestium.client.gui.options.control.ControlValueFormatter;
import net.caffeinemc.mods.nestium.client.gui.options.control.CyclingControl;
import net.caffeinemc.mods.nestium.client.gui.options.control.SliderControl;
import net.caffeinemc.mods.nestium.client.gui.options.control.TickBoxControl;
import net.caffeinemc.mods.nestium.client.gui.options.storage.MinecraftOptionsStorage;
import net.caffeinemc.mods.nestium.client.gui.options.storage.NestiumOptionsStorage;
...
public class NestiumGameOptionPages {
    private static final NestiumOptionsStorage nestiumOpts = new NestiumOptionsStorage();
    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.view_distance.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.simulation_distance.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.brightness.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.gui_scale.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.fullscreen.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.fullscreen_resolution.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.v_sync.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.fps_limit.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.view_bobbing.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(AttackIndicatorStatus.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.attack_indicator.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.autosave_indicator.tooltip"))
                        .setControl(TickBoxControl::new)
    ...
    public static OptionPage quality() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(GraphicsStatus.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.graphics_quality.tooltip"))
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(CloudStatus.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.clouds_quality.tooltip"))
                        ...
                        .build())
                .add(OptionImpl.createBuilder(NestiumGameOptions.GraphicsQuality.class, nestiumOpts)
                        .setName(Component.translatable("soundCategory.weather"))
                        .setTooltip(Component.translatable("nestium.options.weather_quality.tooltip"))
                        .setControl(option -> new CyclingControl<>(option, NestiumGameOptions.GraphicsQuality.class))
                        .setBinding((opts, value) -> opts.quality.weatherQuality = value, opts -> opts.quality.weatherQuality)
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(NestiumGameOptions.GraphicsQuality.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.leaves_quality.name"))
                        .setTooltip(Component.translatable("nestium.options.leaves_quality.tooltip"))
                        .setControl(option -> new CyclingControl<>(option, NestiumGameOptions.GraphicsQuality.class))
                ...
                .add(OptionImpl.createBuilder(ParticleStatus.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.particle_quality.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.smooth_lighting.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.biome_blend.tooltip"))
                ...
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.entity_distance.tooltip"))
                ...
                .add(OptionImpl.createBuilder(boolean.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.entity_shadows.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setBinding((opts, value) -> opts.entityShadows().set(value), opts -> opts.entityShadows().get())
                        .setImpact(OptionImpact.MEDIUM)
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.vignette.name"))
                        .setTooltip(Component.translatable("nestium.options.vignette.tooltip"))
                        .setControl(TickBoxControl::new)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, vanillaOpts)
                        ...
                        .setTooltip(Component.translatable("nestium.options.mipmap_levels.tooltip"))
        ...
        return new OptionPage(Component.translatable("nestium.options.pages.quality"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage performance() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.chunk_update_threads.name"))
                        .setTooltip(Component.translatable("nestium.options.chunk_update_threads.tooltip"))
                        .setControl(o -> new SliderControl(o, 0, Runtime.getRuntime().availableProcessors(), 1, ControlValueFormatter.quantityOrDisabled("nestium.options.common.threads", "nestium.options.common.default")))
                        .setImpact(OptionImpact.HIGH)
                ...
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.always_defer_chunk_updates.name"))
                        .setTooltip(Component.translatable("nestium.options.always_defer_chunk_updates.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.use_block_face_culling.name"))
                        .setTooltip(Component.translatable("nestium.options.use_block_face_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.use_fog_occlusion.name"))
                        .setTooltip(Component.translatable("nestium.options.use_fog_occlusion.tooltip"))
                        .setControl(TickBoxControl::new)
                ...
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.use_entity_culling.name"))
                        .setTooltip(Component.translatable("nestium.options.use_entity_culling.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
                ...
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.animate_only_visible_textures.name"))
                        .setTooltip(Component.translatable("nestium.options.animate_only_visible_textures.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.HIGH)
                ...
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.use_no_error_context.name"))
                        .setTooltip(Component.translatable("nestium.options.use_no_error_context.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.LOW)
                        .setBinding((opts, value) -> opts.performance.useNoErrorGLContext = value, opts -> opts.performance.useNoErrorGLContext)
                        .setEnabled(NestiumGameOptionPages::supportsNoErrorContext)
                        .setFlags(OptionFlag.REQUIRES_GAME_RESTART)
                        .build())
                .build());

        return new OptionPage(Component.translatable("nestium.options.pages.performance"), ImmutableList.copyOf(groups));
    }
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.use_persistent_mapping.name"))
                        .setTooltip(Component.translatable("nestium.options.use_persistent_mapping.tooltip"))
                        .setControl(TickBoxControl::new)
                        .setImpact(OptionImpact.MEDIUM)
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(int.class, nestiumOpts)
                        .setName(Component.translatable("nestium.options.cpu_render_ahead_limit.name"))
                        .setTooltip(Component.translatable("nestium.options.cpu_render_ahead_limit.tooltip"))
                        .setControl(opt -> new SliderControl(opt, 0, 9, 1, ControlValueFormatter.translateVariable("nestium.options.cpu_render_ahead_limit.value")))
                        .setBinding((opts, value) -> opts.advanced.cpuRenderAheadLimit = value, opts -> opts.advanced.cpuRenderAheadLimit)
                        .build()
                )
                .build());

        return new OptionPage(Component.translatable("nestium.options.pages.advanced"), ImmutableList.copyOf(groups));
    }
}
