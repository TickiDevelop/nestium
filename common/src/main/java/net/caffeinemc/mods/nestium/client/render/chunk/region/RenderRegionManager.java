package net.caffeinemc.mods.nestium.client.render.chunk.region;

import it.unimi.dsi.fastutil.longs.Long2ReferenceOpenHashMap;
import it.unimi.dsi.fastutil.objects.Reference2ReferenceMap;
import it.unimi.dsi.fastutil.objects.Reference2ReferenceOpenHashMap;
import net.caffeinemc.mods.nestium.client.NestiumClientMod;
import net.caffeinemc.mods.nestium.client.gl.arena.PendingUpload;
import net.caffeinemc.mods.nestium.client.gl.arena.staging.FallbackStagingBuffer;
import net.caffeinemc.mods.nestium.client.gl.arena.staging.MappedStagingBuffer;
import net.caffeinemc.mods.nestium.client.gl.arena.staging.StagingBuffer;
...
public class RenderRegionManager {
    ...
    private static StagingBuffer createStagingBuffer(CommandList commandList) {
        if (NestiumClientMod.options().advanced.useAdvancedStagingBuffers && MappedStagingBuffer.isSupported(RenderDevice.INSTANCE)) {
