package net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting;
...
import net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline.DefaultFluidRenderer;
import net.caffeinemc.mods.nestium.client.render.chunk.data.BuiltSectionMeshParts;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.bsp_tree.BSPBuildFailureException;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.data.*;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.trigger.GeometryPlanes;
...
public class TranslucentGeometryCollector {
    ...
    private static SortType filterSortType(SortType sortType) {
        SortBehavior sortBehavior = NestiumClientMod.options().debug.getSortBehavior();
        switch (sortBehavior) {
            case OFF:
     ...
     * cases: <a href="https://hackmd.io/@douira100/nestium-sl-gfni#Special-Sorting-Cases">...</a>
     * <p>
