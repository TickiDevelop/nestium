package net.caffeinemc.mods.nestium.client.render.vertex.serializers;

import com.mojang.blaze3d.vertex.VertexFormat;
import it.unimi.dsi.fastutil.longs.Long2ReferenceMap;
import it.unimi.dsi.fastutil.longs.Long2ReferenceOpenHashMap;
import net.caffeinemc.mods.nestium.api.vertex.format.VertexFormatExtensions;
import net.caffeinemc.mods.nestium.client.render.vertex.serializers.generated.VertexSerializerFactory;
import net.caffeinemc.mods.nestium.api.vertex.serializer.VertexSerializer;
import net.caffeinemc.mods.nestium.api.vertex.serializer.VertexSerializerRegistry;
...
public class VertexSerializerRegistryImpl implements VertexSerializerRegistry {
    ...
    static {
        var classDumpPath = System.getProperty("nestium.codegen.dump", null);
    ...
    private static int getGlobalId(VertexFormat format) {
        return ((VertexFormatExtensions) format).nestium$getGlobalId();
    }
}
