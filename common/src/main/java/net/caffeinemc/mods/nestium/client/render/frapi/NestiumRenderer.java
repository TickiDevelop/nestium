...
package net.caffeinemc.mods.nestium.client.render.frapi;

import net.caffeinemc.mods.nestium.client.render.frapi.material.MaterialFinderImpl;
import net.caffeinemc.mods.nestium.client.render.frapi.material.RenderMaterialImpl;
import net.caffeinemc.mods.nestium.client.render.frapi.mesh.MeshBuilderImpl;
...
/**
 * The Nestium renderer implementation.
 */
public class NestiumRenderer implements Renderer {
    public static final NestiumRenderer INSTANCE = new NestiumRenderer();
