...
import net.caffeinemc.mods.nestium.mixin.features.render.frapi.ItemRendererAccessor;
...
public class ItemRenderContext extends AbstractRenderContext {
    ...
    private void computeOutputInfo() {
        ...
        isGlintDynamicDisplay = ItemRendererAccessor.nestium$hasAnimatedTexture(itemStack);
