...
import net.caffeinemc.mods.nestium.client.model.quad.BakedQuadView;
...
import net.caffeinemc.mods.nestium.client.render.frapi.helper.TextureHelper;
...
public abstract class MutableQuadViewImpl extends QuadViewImpl implements QuadEmitter {
    ...
    public void clear() {
        ...
        colorIndex(-1);
        cullFace(null);
        material(NestiumRenderer.STANDARD_MATERIAL);
        cachedSprite(null);
    }
