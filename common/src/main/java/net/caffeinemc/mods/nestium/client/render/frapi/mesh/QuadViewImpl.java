...
import net.caffeinemc.mods.nestium.client.render.frapi.helper.GeometryHelper;
import net.caffeinemc.mods.nestium.client.render.frapi.helper.NormalHelper;
...
import static net.caffeinemc.mods.nestium.client.render.frapi.mesh.EncodingFormat.*;
