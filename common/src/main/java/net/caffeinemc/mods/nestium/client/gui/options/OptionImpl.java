...
import net.caffeinemc.mods.nestium.client.gui.options.binding.GenericBinding;
import net.caffeinemc.mods.nestium.client.gui.options.binding.OptionBinding;
