package net.caffeinemc.mods.nestium.client.render.immediate;
...
import net.caffeinemc.mods.nestium.api.vertex.format.common.ColorVertex;
...
public class CloudRenderer {
    private static final Logger LOGGER = LoggerFactory.getLogger("Nestium-CloudRenderer");
