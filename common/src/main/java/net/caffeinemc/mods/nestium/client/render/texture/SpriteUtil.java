...
public class SpriteUtil {
    ...
    public static void markSpriteActive(@Nullable TextureAtlasSprite sprite) {
        if (sprite != null) {
            net.caffeinemc.mods.nestium.api.texture.SpriteUtil.INSTANCE.markSpriteActive(sprite);
        }
    }
    ...
    public static boolean hasAnimation(@Nullable TextureAtlasSprite sprite) {
        if (sprite != null) {
            return net.caffeinemc.mods.nestium.api.texture.SpriteUtil.INSTANCE.hasAnimation(sprite);
        }
