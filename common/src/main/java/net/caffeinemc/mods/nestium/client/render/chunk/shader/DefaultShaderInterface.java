package net.caffeinemc.mods.nestium.client.render.chunk.shader;

import com.mojang.blaze3d.platform.GlStateManager;
import net.caffeinemc.mods.nestium.client.gl.device.GLRenderDevice;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniformFloat2v;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniformFloat3v;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniformInt;
import net.caffeinemc.mods.nestium.client.gl.shader.uniform.GlUniformMatrix4f;
import net.caffeinemc.mods.nestium.client.render.chunk.vertex.format.impl.CompactChunkVertex;
import net.caffeinemc.mods.nestium.client.util.TextureUtil;
import net.caffeinemc.mods.nestium.mixin.core.render.texture.TextureAtlasAccessor;
