package net.caffeinemc.mods.nestium.mixin.features.textures.scan;

import com.llamalad7.mixinextras.injector.wrapoperation.Operation;
import com.llamalad7.mixinextras.injector.wrapoperation.WrapOperation;
import com.mojang.blaze3d.platform.NativeImage;
import net.caffeinemc.mods.nestium.api.util.ColorABGR;
import net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline.SpriteContentsExtension;
import net.caffeinemc.mods.nestium.client.util.NativeImageHelper;
...
public class SpriteContentsMixin implements SpriteContentsExtension {
    ...
    @Unique
    public boolean nestium$hasTransparentPixels = false;

    @Unique
    public boolean nestium$hasTranslucentPixels = false;
    ...
    private void nestium$beforeGenerateMipLevels(SpriteContents instance, NativeImage nativeImage, Operation<Void> original) {
    ...
    private void scanSpriteContents(NativeImage nativeImage) {
        ...
        for (int pixelIndex = 0; pixelIndex < pixelCount; pixelIndex++) {
            ...
            if (alpha <= 25) { // 0.1 * 255
                this.nestium$hasTransparentPixels = true;
            } else if (alpha < 255) {
                this.nestium$hasTranslucentPixels = true;
            }
        }
        ...
        this.nestium$hasTransparentPixels |= this.nestium$hasTranslucentPixels;
    }

    @Override
    public boolean nestium$hasTransparentPixels() {
        return this.nestium$hasTransparentPixels;
    }

    @Override
    public boolean nestium$hasTranslucentPixels() {
        return this.nestium$hasTranslucentPixels;
    }
}
