package net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.trigger;

import java.util.List;
import java.util.function.BiConsumer;

import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.SortBehavior;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.data.DynamicData;
import org.joml.Vector3dc;

import it.unimi.dsi.fastutil.objects.ObjectOpenHashSet;
import net.caffeinemc.mods.nestium.client.NestiumClientMod;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.AlignableNormal;
...
public class SortTriggering {
    ...
    public void addDebugStrings(List<String> list) {
        var sortBehavior = NestiumClientMod.options().debug.getSortBehavior();
