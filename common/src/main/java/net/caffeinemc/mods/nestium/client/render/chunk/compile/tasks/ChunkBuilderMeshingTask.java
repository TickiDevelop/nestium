package net.caffeinemc.mods.nestium.client.render.chunk.compile.tasks;
...
import net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline.BlockRenderCache;
import net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline.BlockRenderer;
import net.caffeinemc.mods.nestium.client.render.chunk.data.BuiltSectionInfo;
import net.caffeinemc.mods.nestium.client.render.chunk.data.BuiltSectionMeshParts;
...
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.SortType;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.TranslucentGeometryCollector;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.data.PresentTranslucentData;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.data.TranslucentData;
import net.caffeinemc.mods.nestium.client.services.PlatformLevelRenderHooks;
...
public class ChunkBuilderMeshingTask extends ChunkBuilderTask<ChunkBuildOutput> {
    ...
    public ChunkBuildOutput execute(ChunkBuildContext buildContext, CancellationToken cancellationToken) {
        ...
        if (NestiumClientMod.options().debug.getSortBehavior() != SortBehavior.OFF) {
