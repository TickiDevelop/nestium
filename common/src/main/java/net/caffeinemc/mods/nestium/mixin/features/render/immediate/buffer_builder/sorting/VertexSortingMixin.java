package net.caffeinemc.mods.nestium.mixin.features.render.immediate.buffer_builder.sorting;

import com.mojang.blaze3d.vertex.VertexSorting;
import net.caffeinemc.mods.nestium.client.util.sorting.VertexSorters;
