package net.caffeinemc.mods.nestium.mixin.core.model;
...
public class TextureAtlasSpriteMixin {
    ...
    public float uvShrinkRatio() {
        ...
        // This is counterproductive with Nestium's terrain rendering, since the bias is applied in the shader instead.
