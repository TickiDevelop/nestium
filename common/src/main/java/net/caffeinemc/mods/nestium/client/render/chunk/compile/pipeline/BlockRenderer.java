package net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline;

import net.caffeinemc.mods.nestium.api.util.ColorABGR;
import net.caffeinemc.mods.nestium.api.util.ColorARGB;
import net.caffeinemc.mods.nestium.api.util.ColorMixer;
...
import net.caffeinemc.mods.nestium.client.model.light.LightMode;
import net.caffeinemc.mods.nestium.client.model.light.LightPipelineProvider;
import net.caffeinemc.mods.nestium.client.model.quad.properties.ModelQuadFacing;
import net.caffeinemc.mods.nestium.client.model.quad.properties.ModelQuadOrientation;
import net.caffeinemc.mods.nestium.client.render.chunk.compile.ChunkBuildBuffers;
import net.caffeinemc.mods.nestium.client.render.chunk.compile.buffers.ChunkModelBuilder;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.DefaultTerrainRenderPasses;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.TerrainRenderPass;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.material.DefaultMaterials;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.material.Material;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.material.parameters.AlphaCutoffParameter;
import net.caffeinemc.mods.nestium.client.render.chunk.terrain.material.parameters.MaterialParameters;
import net.caffeinemc.mods.nestium.client.render.chunk.translucent_sorting.TranslucentGeometryCollector;
import net.caffeinemc.mods.nestium.client.render.chunk.vertex.builder.ChunkMeshBufferBuilder;
import net.caffeinemc.mods.nestium.client.render.chunk.vertex.format.ChunkVertexEncoder;
import net.caffeinemc.mods.nestium.client.render.frapi.mesh.MutableQuadViewImpl;
...
public class BlockRenderer extends AbstractBlockRenderContext {
    ...
    public void renderModel(BakedModel model, BlockState state, BlockPos pos, BlockPos origin) {
        ...
        while (it.hasNext()) {
            ...
            // TODO: This can be removed once we have a better solution for https://github.com/CaffeineMC/nestium/issues/2868
        ...
        type = null;
        modelData = NestiumModelData.EMPTY;
    }
    ...
    private static TerrainRenderPass getDowngradedPass(TextureAtlasSprite sprite, TerrainRenderPass pass) {
        if (sprite instanceof TextureAtlasSpriteExtension spriteExt) {
            ...
            if (spriteExt.nestium$hasUnknownImageContents()) {
                return pass;
            }

            if (sprite.contents() instanceof SpriteContentsExtension contentsExt) {
                if (pass == DefaultTerrainRenderPasses.TRANSLUCENT && !contentsExt.nestium$hasTranslucentPixels()) {
                    pass = DefaultTerrainRenderPasses.CUTOUT;
                }
                if (pass == DefaultTerrainRenderPasses.CUTOUT && !contentsExt.nestium$hasTransparentPixels()) {
