package net.caffeinemc.mods.nestium.client.render.frapi.render;
...
import net.caffeinemc.mods.nestium.client.render.chunk.compile.pipeline.BlockOcclusionCache;
import net.caffeinemc.mods.nestium.client.render.frapi.NestiumRenderer;
import net.caffeinemc.mods.nestium.client.render.frapi.helper.ColorHelper;
import net.caffeinemc.mods.nestium.client.render.frapi.mesh.EncodingFormat;
...
public abstract class AbstractBlockRenderContext extends AbstractRenderContext {
    ...
    private static final RenderMaterial TRANSLUCENT_MATERIAL = NestiumRenderer.INSTANCE.materialFinder().blendMode(BlendMode.TRANSLUCENT).find();
    ...
    static {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            STANDARD_MATERIALS[i] = NestiumRenderer.INSTANCE.materialFinder().ambientOcclusion(state).find();
        }
    }
