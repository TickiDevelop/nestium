package net.caffeinemc.mods.nestium.client.render;
...
import net.caffeinemc.mods.nestium.client.render.chunk.ChunkRenderMatrices;
import net.caffeinemc.mods.nestium.client.render.chunk.RenderSectionManager;
...
import net.caffeinemc.mods.nestium.client.render.chunk.map.ChunkTracker;
import net.caffeinemc.mods.nestium.client.render.chunk.map.ChunkTrackerHolder;
 ...
 */
public class NestiumWorldRenderer {
    ...
    /**
     * @return The NestiumWorldRenderer based on the current dimension
     */
    public static NestiumWorldRenderer instance() {
    ...
    /**
     * @return The NestiumWorldRenderer based on the current dimension, or null if none is attached
     */
    public static NestiumWorldRenderer instanceNullable() {
        var level = Minecraft.getInstance().levelRenderer;

        if (level instanceof LevelRendererExtension extension) {
            return extension.nestium$getWorldRenderer();
        }

        return null;
    }

    public NestiumWorldRenderer(Minecraft client) {
        this.client = client;
    }
    ...
    public void setupTerrain(Camera camera,
        ...
        this.useEntityCulling = NestiumClientMod.options().performance.useEntityCulling;
