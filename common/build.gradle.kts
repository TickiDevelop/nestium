...
dependencies {
    ...
    compileOnly("org.lwjgl:lwjgl-jemalloc:3.3.3")

    annotationProcessor("org.lwjgl:lwjgl:3.3.3")
    annotationProcessor("org.lwjgl:lwjgl-glfw:3.3.3")
    annotationProcessor("org.lwjgl:lwjgl-opengl:3.3.3")
    annotationProcessor("org.lwjgl:lwjgl-stb:3.3.3")
    annotationProcessor("org.lwjgl:lwjgl-jemalloc:3.3.3")

    api("com.logisticscraft:occlusionculling:0.0.6-SNAPSHOT")
}

loom {
    accessWidenerPath = file("src/main/resources/nestium-common.accesswidener")

    mixin {
        // useLegacyMixinAp = true
        defaultRefmapName.set("nestium.mixins.refmap.json")
    }
}
