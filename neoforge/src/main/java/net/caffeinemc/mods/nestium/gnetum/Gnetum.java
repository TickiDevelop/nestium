...
import net.caffeinemc.mods.nestium.gnetum.compat.embeddium.GnetumEmbeddiumCompat;
...
public final class Gnetum {
    ...
    public static final String MOD_ID = "nestium";
    public static final String HAND_ELEMENT = "nestium_gnetum:minecraft_hand";
    public static final String OTHER_MODS = "nestium_gnetum_unknown";
    ...
    public static final Lazy<KeyMapping> CONFIG_MAPPING = Lazy.of(() -> new KeyMapping(
            "nestium.gnetum.config.keyMapping",
            KeyConflictContext.IN_GAME,
            InputConstants.Type.KEYSYM,
            GLFW.GLFW_KEY_END,
            "key.categories.misc"));

    public Gnetum(ModContainer container, IEventBus modBus, Dist dist) {
