...
import net.caffeinemc.mods.nestium.ferritecore.ducks.FastMapStateHolder;
import net.caffeinemc.mods.nestium.ferritecore.fastmap.FastMap;
import net.caffeinemc.mods.nestium.ferritecore.fastmap.table.CrashNeighborTable;
import net.caffeinemc.mods.nestium.ferritecore.fastmap.table.FastmapNeighborTable;
