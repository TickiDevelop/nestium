...
import net.caffeinemc.mods.nestium.ferritecore.mixin.accessors.BitSetDVSAccess;
import net.caffeinemc.mods.nestium.ferritecore.mixin.accessors.DiscreteVSAccess;
import net.caffeinemc.mods.nestium.ferritecore.mixin.accessors.SubShapeAccess;
