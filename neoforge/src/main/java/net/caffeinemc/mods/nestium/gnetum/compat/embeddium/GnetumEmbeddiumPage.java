package net.caffeinemc.mods.nestium.gnetum.compat.embeddium;
...
public class GnetumEmbeddiumPage extends OptionPage {
    public GnetumEmbeddiumPage() {
        super(OptionIdentifier.create("nestium_gnetum", "basic"), Component.translatable("nestium.gnetum.title"), groups());
    }
    ...
    private static ImmutableList<OptionGroup> groups() {
        ...
        var general = OptionGroup.createBuilder().setId(ResourceLocation.fromNamespaceAndPath("nestium_gnetum", "general"));

        var enabledOption = OptionImpl.createBuilder(boolean.class, STORAGE)
                .setId(ResourceLocation.fromNamespaceAndPath("nestium_gnetum", "enabled"))
        ...
        general.add(OptionImpl.createBuilder(boolean.class, STORAGE)
                .setId(ResourceLocation.fromNamespaceAndPath("nestium_gnetum", "show_fps"))
        ...
        general.add(OptionImpl.createBuilder(int.class, STORAGE)
                .setId(ResourceLocation.fromNamespaceAndPath("nestium_gnetum", "number_of_passes"))
                ...
                .build());
        general.add(OptionImpl.createBuilder(int.class, STORAGE)
                .setId(ResourceLocation.fromNamespaceAndPath("nestium_gnetum", "max_fps"))
