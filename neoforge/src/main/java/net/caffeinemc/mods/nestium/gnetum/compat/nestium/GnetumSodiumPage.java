package net.caffeinemc.mods.nestium.gnetum.compat.nestium;

import com.google.common.collect.ImmutableList;
import net.caffeinemc.mods.nestium.gnetum.Gnetum;
import net.caffeinemc.mods.nestium.gnetum.GnetumConfig;
import net.caffeinemc.mods.nestium.client.gui.options.OptionGroup;
import net.caffeinemc.mods.nestium.client.gui.options.OptionImpact;
import net.caffeinemc.mods.nestium.client.gui.options.OptionImpl;
...
public class GnetumSodiumPage extends OptionPage {
    public GnetumSodiumPage() {
        super(Component.translatable("nestium.gnetum.title"), groups());
    }
    ...
    private static ImmutableList<OptionGroup> groups() {
        ...
        var enabledOption = OptionImpl.createBuilder(boolean.class, STORAGE)
            .setName(Component.translatable("nestium.gnetum.config.enabled"))
            .setTooltip(Component.translatable("nestium.gnetum.config.enabled.tooltip"))
        ...
        general.add(OptionImpl.createBuilder(boolean.class, STORAGE)
                ...
                .setName(Component.translatable("nestium.gnetum.config.showFps"))
                .setTooltip(Component.translatable("nestium.gnetum.config.showFps.tooltip"))
                .setControl(TickBoxControl::new)
                .setBinding((opts, value) -> {
        ...
        general.add(OptionImpl.createBuilder(int.class, STORAGE)
                .setEnabled(enabledOption::getValue)
                .setName(Component.translatable("nestium.gnetum.config.numberOfPasses"))
                .setTooltip(Component.translatable("nestium.gnetum.config.numberOfPasses.tooltip"))
        ...
        general.add(OptionImpl.createBuilder(int.class, STORAGE)
                .setEnabled(enabledOption::getValue)
                .setName(Component.translatable("nestium.gnetum.config.maxFps"))
                .setTooltip(Component.translatable("nestium.gnetum.config.maxFps.tooltip"))
                .setImpact(OptionImpact.MEDIUM)
