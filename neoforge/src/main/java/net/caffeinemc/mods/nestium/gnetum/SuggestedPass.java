...
import net.caffeinemc.mods.nestium.gnetum.mixins.GuiAccessor;
import net.caffeinemc.mods.nestium.gnetum.mixins.GuiLayerManagerAccessor;
...
public class SuggestedPass {
    public static int get(String name) {
        int pass = switch (name) {
            ...
            case "minecraft:jump_meter", "minecraft:experience_bar", "nestium_gnetum:status_bar", "minecraft:selected_item_name", "minecraft:spectator_tooltip", "minecraft:experience_level" -> 2;
