package net.caffeinemc.mods.nestium.fabric.render;
...
import net.caffeinemc.mods.nestium.client.services.FluidRendererFactory;
...
public class FluidRendererImpl extends FluidRenderer {
    ...
    public void render(LevelSlice level, BlockState blockState, FluidState fluidState, BlockPos blockPos, BlockPos offset, TranslucentGeometryCollector collector, ChunkBuildBuffers buffers) {
        ...
        //
        // Nestium cannot let vanilla FluidRenderer#render run (during the invocation of FluidRenderHandler#renderFluid)
        // for two reasons.
        ...
        //
        // Due to all the above, Nestium injects into head of vanilla FluidRenderer#render before Fabric API and cancels
        ...
        // To allow invoking this method from the injector, where there is no local Nestium context, the renderer and
